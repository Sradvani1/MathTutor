    ...
    return (
        <div className="text-center p-8 flex-1 flex flex-col items-center justify-center">
            <div className="max-w-2xl mx-auto">
                <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Welcome to your AI Math Tutor</h2>
                ...
                <button
                    ...
                    className="bg-teal-500 hover:bg-teal-400 text-white font-bold py-3 px-6 rounded-full transition-all duration-300 transform hover:scale-105 inline-flex items-center gap-2"
                >
